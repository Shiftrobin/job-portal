<!DOCTYPE html>
<html class="no-js h-100" lang="en_AU" />
<head>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3 fw-bold fs-5">
		<div class="container">
			<a class="navbar-brand" href="https://aimseducation.co.uk/">
                <img src="{{ asset('public/logo.png') }}" alt="logo" width="180" height="48">
            </a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					<li class="nav-item">
						<a class="nav-link" aria-current="page" href="https://aimseducation.co.uk/">Home</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" aria-current="page" href="{{ route('home') }}">Career</a>
					</li>
					<li class="nav-item">
                ...
                @if (!Auth::check())
                    ...
                    <a class="btn btn-outline-primary me-2" href="{{ route('account.registration') }}">Registration</a>
                @else
                    @if (Auth::user()->role == 'admin')
                        <a class="btn btn-outline-primary me-2" href="{{ route('admin.dashboard') }}">Dashboard</a>
                        <a class="btn btn-outline-primary me-2" href="{{ route('admin.profile') }}">My Account</a>
...
<footer class="py-3 bg-2" style="background: #007089;">
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© {{ now()->year }} AIMS Education, all right reserved</p>
</div>
</footer>
