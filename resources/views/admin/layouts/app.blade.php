	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="ms-auto">
                    @if (!Auth::check())
                         <a class="btn btn-outline-primary me-2" href="{{ route('home') }}" target="_blank">Visit Site</a>
                    @else
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="AdminProfilePicForm" name="AdminProfilePicForm" method="post">
            <div class="mb-3">
...
//admin profile pic
$("#AdminProfilePicForm").submit(function(e){
    e.preventDefault();

    var formData = new FormData(this);

    $.ajax({
        url: '{{ route("admin.update.profile.pic") }}',
        type: 'post',
        data: formData,
        dataType: 'json',
        contentType: false,
