                ...
                <form method="post" id="createJobForm" name="createJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-1">Create a Job Post</h3>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-4">
                                    <label for="" class="mb-2">Dead Line<span class="req">*</span></label>
                                    <input type="text" placeholder="deadline" id="deadline" name="deadline" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="reponsibility" id="reponsibility" cols="5" rows="5" placeholder="Responsibility"></textarea>
                            </div>
                            <div class="mb-4">
